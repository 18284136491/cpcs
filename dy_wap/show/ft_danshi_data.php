...
$sql		=	"select id from bet_match WHERE Match_Type=1 AND Match_CoverDate>now() AND Match_Date='".date("m-d")."' and Match_HalfId is not null ".$sqlwhere.' order by Match_CoverDate,iPage,match_name,Match_Master,Match_ID,iSn';
