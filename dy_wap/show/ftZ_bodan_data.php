...
$sql		=	"select id from bet_match where Match_Type=0 and Match_IsShowbd=1 and Match_CoverDate>now() and Match_Bd21>0 ".$sqlwhere.' order by Match_CoverDate,iPage,match_name,Match_Master,Match_ID,iSn';
