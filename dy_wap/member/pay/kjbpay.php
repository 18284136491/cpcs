								...
								<tr>
									<td colspan="2" align="center">
										<table border="0" cellspacing="0" cellpadding="0">
											<tr height="42">
												<td width="20"><input type="radio" name="Bankco" value="ICBC-KJB-B2C" checked="checked" /></td>
												<td width="174"><img src="skin/hxbank/gongshang.gif" /></td>
												<td width="20"><input type="radio" name="Bankco" value="CCB-KJB-B2C" /></td>
												<td width="174"><img src="skin/hxbank/jianshe.gif" /></td>
												<td width="20"><input type="radio" name="Bankco" value="ABC-KJB-B2C" /></td>
												<td width="174"><img src="skin/hxbank/nongye.gif" /></td>
												<td width="20"><input type="radio" name="Bankco" value="CMBCHINA-KJB-B2C" /></td>
												<td width="174"><img src="skin/hxbank/zhaohang.gif" /></td>
											</tr>
											<tr height="42">
												<td width="20"><input type="radio" name="Bankco" value="BOCO-KJB-B2C" /></td>
												<td width="174"><img src="skin/hxbank/jiaotong.gif" /></td>
												<td width="20"><input type="radio" name="Bankco" value="CMBC-KJB-B2C" /></td>
												<td width="174"><img src="skin/hxbank/minsheng.gif" /></td>
												<td width="20"><input type="radio" name="Bankco" value="CIB-KJB-B2C" /></td>
												<td width="174"><img src="skin/hxbank/xingye.gif" /></td>
												<td width="20"><input type="radio" name="Bankco" value="BOC-KJB-B2C" /></td>
												<td width="174"><img src="skin/hxbank/zhongguo.gif" /></td>
											</tr>
											<tr height="42">
												<td width="20"><input type="radio" name="Bankco" value="NJCB-KJB-B2C" /></td>
												<td width="174"><img src="skin/hxbank/nanjing.gif" /></td>
												<td width="20"><input type="radio" name="Bankco" value="CEB-KJB-B2C" /></td>
												<td width="174"><img src="skin/hxbank/guangda.gif" /></td>
												<td width="20"><input type="radio" name="Bankco" value="GDB-KJB-B2C" /></td>
												<td width="174"><img src="skin/hxbank/guangfa.gif" /></td>
												<td width="20"><input type="radio" name="Bankco" value="PINGANBANK-KJB" /></td>
												<td width="174"><img src="skin/hxbank/pingan.gif" /></td>
											</tr>
											<tr height="42">
												<td width="20"><input type="radio" name="Bankco" value="POST-KJB-B2C" /></td>
												<td width="174"><img src="skin/hxbank/youzheng.gif" /></td>
												<td width="20"><input type="radio" name="Bankco" value="BCCB-KJB-B2C" /></td>
												<td width="174"><img src="skin/hxbank/beijing.gif" /></td>
												<td width="20"><input type="radio" name="Bankco" value="CBHB-KJB-B2C" /></td>
												<td width="174"><img src="skin/hxbank/buohai.gif" /></td>
												<td width="20"><input type="radio" name="Bankco" value="HKBEA-KJB-B2C" /></td>
												<td width="174"><img src="skin/hxbank/dongya.gif" /></td>
											</tr>
											<tr height="42">
												<td width="20"><input type="radio" name="Bankco" value="NBCB-KJB-B2C" /></td>
												<td width="174"><img src="skin/hxbank/ningbo.gif" /></td>
												<td width="20"><input type="radio" name="Bankco" value="ECITIC-KJB-B2C" /></td>
												<td width="174"><img src="skin/hxbank/zhongxin.gif" /></td>
												<td width="20"><input type="radio" name="Bankco" value="SHB-KJB-B2C" /></td>
												<td width="174"><img src="skin/hxbank/shanghaibank.gif" /></td>
												<td width="20"><input type="radio" name="Bankco" value="CZ-KJB-B2C" /></td>
												<td width="174"><img src="skin/hxbank/zheshang.gif" /></td>
											</tr>
											<tr height="42">
												<td width="20"><input type="radio" name="Bankco" value="ALIPAY-KJB-B2C" /></td>
												<td width="174"><img src="skin/kjbbank/alipay.gif" /></td>
												<td width="20"><input type="radio" name="Bankco" value="BJRCB-KJB-B2C" /></td>
												<td width="174"><img src="skin/hxbank/nongcunshangye.gif" /></td>
												<td width="20"><input type="radio" name="Bankco" value="HZBANK-KJB-B2C" /></td>
												<td width="174"><img src="skin/hxbank/hangzhou.gif" /></td>
												<td width="20"><input type="radio" name="Bankco" value="NCBBANK-KJB-B2C" /></td>
												<td width="174"><img src="skin/hxbank/nanyanbank.gif" /></td>
											</tr>
											<tr height="42">
												<td width="20"><input type="radio" name="Bankco" value="SPDB-KJB-B2C" /></td>
												<td width="174"><img src="skin/hxbank/shangpufa.gif" /></td>
												<td width="20"><input type="radio" name="Bankco" value="SRCB-KJB-B2C" /></td>
												<td width="174"><img src="skin/hxbank/shangnongshang.gif" /></td>
												<td width="20"><input type="radio" name="Bankco" value="SCCB-KJB-B2C" /></td>
												<td width="174"><img src="skin/hxbank/hebei.gif" /></td>
												<td width="20"><input type="radio" name="Bankco" value="ZJTLCB-KJB-B2C" /></td>
