        ...
        <div class="wrap">
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="1">
                <tr class="tic c_red f_b">
                    <td colspan="2">请选择以下公司账号进行转账汇款</td>
                </tr>
                <?php
                ...
                foreach($bank[$_SESSION["gid"]] as $k=>$arr) {
                    ...
                    <tr class="list">
                        ...
                        <td align="left">
                            <span><?=$arr['card_bankName']?>：<em class="c_blue"><?=$arr['card_ID']?></em></span><br>
                            开户名：<span class="c_blue"><?=$arr['card_userName']?></span><br>
                            开户行所在城市：<span class="c_blue"><?=$arr['card_address']?></span>
                        </td>
                    </tr>
                <?php } ?>
                <tr>
            ...
            <form id="form1" name="form1" action="?into=true" method="post">
                <table width="100%" border="0" cellpadding="0" cellspacing="1" class="mt10">
                    ...
                    <tr>
                        ...
                        <td>
                            <input name="cn_date" type="text" id="cn_date" class="input_150 laydate-icon" maxlength="10" readonly="readonly" value="<?=date("Y-m-d",$lottery_time)?>" onclick="laydate({format: 'YYYY-MM-DD', isclear: false, max: laydate.now()});" style="margin-bottom: 5px"/>
                            <div>
