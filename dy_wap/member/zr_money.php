                ...
                <table cellspacing="1" cellpadding="0" border="0" class="tab1">
                    ...
                    <tr>
                        ...
                        <td class="c_red">
                            ...
                            $json_ag = json_decode($yy);
                            ?>
                            <span>[系统] <?=sprintf("%.2f",$userinfo["money"])?></span><br>
                            <span>[BB真人] <?=sprintf("%.2f",$json_bb->value)?></span><br>
                            <span>[AG] <?=sprintf("%.2f", $json_ag->value)?></span>
                        </td>
                    </tr>
                    <tr>
