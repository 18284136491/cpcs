...
<div class="ucenter">
			  ...
			  <div class="panel-zd">
			    <div role="tabpanel">
				  ...
				  <ul class="nav nav-tabs nav-tile" role="tablist">
				    <li class="active"><a href="cha_ckonline.php?type=4">存款记录</a></li>
	...
	<tr align="center" bgcolor="#FFFFFF"  height="20" onmouseover="this.style.background='#EEEEEE'" onmouseout="this.style.background='#ffffff'">
	 ...
	 <div class="panel-footer">  	
  	<ul class="pagination"><?=$page->get_htmlPage($_SERVER["REQUEST_URI"]);?> <li><a href="javascript:;">本页存款成功总金额：<font color="#D7524E"><?=sprintf("%.2f",$sum_money)?></font> RMB </a></li></ul>
  </div>
						</div>
				    </div>
				  </div>
