...
下级代理注册链接:
<?php
    $link='http://'.$_SERVER["HTTP_HOST"]."/?action=zhuce".htmlspecialchars("&")."para=referrals%3d".$_SESSION["username"];
?>
...
$sql		=	"select uid,username from k_user where top_uid=".$_SESSION["uid"]."$where order by uid desc";
...
?>
	<tr align="center" >
    <td height="30" colspan="4" valign="middle" bgcolor="#FFFFFF"><span class="STYLE1">暂无下级</span></td>
    </tr>
<?php
}
?>
