            ...
            <table cellspacing="0" cellpadding="0" border="0" class="tb_list">
                ...
                if($id) {
                    ...
                    while($row = $query->fetch_array()) {
                        ...
                        $hm[] = $row['ball_3'];
                        $hm[] = $row['ball_4'];
                        $qiu = "<em class='v_m n_$row[ball_1]'></em> <i class='v_m'>+</i> <em class='v_m n_$row[ball_2]'></em> <i class='v_m'>+</i> <em class='v_m n_$row[ball_3]'></em> <i class='v_m'>=</i> <em class='v_m n_$row[ball_4]'></em>";
                        ?>
                        <tr class="list">
                            <td><?=$row['qishu']?></td>
                            <td class="xy28"><?=$qiu?></td>
                        </tr>
                        <?php
                    }
                }
