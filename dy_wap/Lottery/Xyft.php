...
<body mode="gm">
    ...
    <div class="container-fluid gm_main">
            ...
            <ul class="g_type">
                <li>
                    ...
                    <table cellspacing="0" cellpadding="0" border="0" class="table table-bordered">
                        ...
                        <tr><td><a href="Xyft.php?t=两面盘">两面盘</a> <i class="icon-angle-right"></i></td></tr>
                        <tr><td><a href="Xyft.php?t=冠亚和">冠亚和</a> <i class="icon-angle-right"></i></td></tr>
                        <tr><td><a href="Xyft.php?t=1~10名">1~10名</a> <i class="icon-angle-right"></i></td></tr>
                    </table>
        ...
        <div class="wrap">
            ...
            <div class="tz">
                <form name="orders" id="orders" action="order/order4.php?type=8" method="post" target="OrderFrame">
                    <?php if($type == '两面盘') { ?>
                        <div class="tz_box">
