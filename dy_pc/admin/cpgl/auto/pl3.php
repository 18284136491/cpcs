...
<body>
<?
$mysql = "select * from lottery_k_pl3 where qihao=".$qi;
...
$hmhz = $bw+$sw+$gw;
$sql = "select * from lottery_data where atype='pl3' and mid='".$qi."' and bet_ok=0 order by ID asc";
...
$msql="update lottery_k_pl3 set ok=1 where qihao=".$qi;
mysql_db_query($dbname,$msql) or die ("修改期數狀態失敗");
?>
<script language=javascript>alert('體彩排列3第<?=$qi?>開獎完畢！'); location.href = '../lottery_auto_pl3.php'</script>
</body>
</html>