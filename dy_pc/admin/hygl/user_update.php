...
$pay_name = $rs['pay_name'];

$sql			=	"update k_user set ";
$sql			=	$sql."ask='$ask',answer='$answer',mobile='$mobile',email='$email',pay_name='$pay_name',pay_card='$pay_card',pay_address='$pay_address',pay_num='$pay_num',gid='$gid',why='$why'";
if($_POST["pass"]!=''){
