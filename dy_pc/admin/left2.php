		...
		<div class="bg_01">
			<div class="bg_02">
				<div class="bg_03">
					<div class="system">
						<div class="img"></div>
						<div class="txt10"><span><?=@$_SESSION['about']?></span></div>
					</div>
					<?php
					if(strpos($quanxian,'zdgl') || strpos($quanxian,'sgjzd')){
					?>
					<div class="bg_10" id="zdgl" onclick="s_h('zdgl','zdgl_1')">注单管理</div>
					...
					?>
					<div class="bg_10" id="bfgl" onclick="s_h('bfgl','bfgl_1')">比分管理</div>
					...
					?>
					<div class="bg_10" id="hygl" onclick="s_h('hygl','hygl_1')">会员管理</div>
					<div class="bg_11" id="hygl_1">
						<table width="100%" height="30" border="0" cellpadding="0" cellspacing="0">
                            <tr onMouseOver="this.style.backgroundColor='#C0E0F8'" onMouseOut="this.style.backgroundColor='#FFFFFF'" style="background-color:#FFFFFF;" height="30" >
								<td align="center" valign="middle"><a href="hygl/list.php?1=1" target="mainFrame"  >会员管理</a></td>
							</tr>
							<tr onMouseOver="this.style.backgroundColor='#C0E0F8'" onMouseOut="this.style.backgroundColor='#FFFFFF'" style="background-color:#FFFFFF;" height="30" >
								<td align="center" valign="middle"><a href="hygl/login_ip.php" target="mainFrame" >会员登陆IP</a></td>
							</tr>
							<tr onMouseOver="this.style.backgroundColor='#C0E0F8'" onMouseOut="this.style.backgroundColor='#FFFFFF'" style="background-color:#FFFFFF;" height="30" >
								<td align="center" valign="middle"><a href="hygl/jkhy.php" target="mainFrame" >监控会员</a></td>
							</tr>
							<tr onMouseOver="this.style.backgroundColor='#C0E0F8'" onMouseOut="this.style.backgroundColor='#FFFFFF'" style="background-color:#FFFFFF;" height="30" >
								<td align="center" valign="middle"><a href="hygl/lsyhxx.php" target="mainFrame" >历史银行信息</a></td>
							</tr>
                            <tr onMouseOver="this.style.backgroundColor='#C0E0F8'" onMouseOut="this.style.backgroundColor='#FFFFFF'" style="background-color:#FFFFFF;" height="30" >
					...
					<div class="bg_11" id="cwgl_1">
						<table width="100%" height="30" border="0" cellpadding="0" cellspacing="0">
                            <tr onMouseOver="this.style.backgroundColor='#C0E0F8'" onMouseOut="this.style.backgroundColor='#FFFFFF'" style="background-color:#FFFFFF;" height="30" >
								<td align="center" valign="middle"><a href="cwgl/chongzhi.php?status=2" target="mainFrame"  >存款管理</a></td>
							</tr>
							<tr onMouseOver="this.style.backgroundColor='#C0E0F8'" onMouseOut="this.style.backgroundColor='#FFFFFF'" style="background-color:#FFFFFF;" height="30" >
								<td align="center" valign="middle"><a href="cwgl/tixian.php?status=2" target="mainFrame"  >提款管理</a></td>
							</tr>
							<tr onMouseOver="this.style.backgroundColor='#C0E0F8'" onMouseOut="this.style.backgroundColor='#FFFFFF'" style="background-color:#FFFFFF;" height="30" >
								<td align="center" valign="middle"><a href="cwgl/huikuan.php?status=0" target="mainFrame">汇款管理</a></td>
							</tr>
							<?php
							...
							?>
							<tr onMouseOver="this.style.backgroundColor='#C0E0F8'" onMouseOut="this.style.backgroundColor='#FFFFFF'" style="background-color:#FFFFFF;" height="30" >
								<td align="center" valign="middle"><a href="cwgl/hccw.php" target="mainFrame">会员存/取/汇款</a></td>
							</tr>
							<tr onMouseOver="this.style.backgroundColor='#C0E0F8'" onMouseOut="this.style.backgroundColor='#FFFFFF'" style="background-color:#FFFFFF;" height="30" >
					...
					?>
					<div class="bg_10" id="fsgl" onclick="s_h('fsgl','fsgl_1')">返水管理</div>
					...
					<div class="bg_11" id="xxgl_1">
						<table width="100%" height="30" border="0" cellpadding="0" cellspacing="0">
							...
							<tr onMouseOver="this.style.backgroundColor='#C0E0F8'" onMouseOut="this.style.backgroundColor='#FFFFFF'" style="background-color:#FFFFFF;" height="30" >
								<td align="center" valign="middle"><a href="xxgl/tsjy.php?1=1" target="mainFrame">投诉建议</a></td>
							</tr>
							<tr onMouseOver="this.style.backgroundColor='#C0E0F8'" onMouseOut="this.style.backgroundColor='#FFFFFF'" style="background-color:#FFFFFF;" height="30" >
					...
					?>
					<div class="bg_10" id="dlgl" onclick="s_h('dlgl','dlgl_1')">代理管理</div>
					<div class="bg_11" id="dlgl_1">
						<table width="100%" height="30" border="0" cellpadding="0" cellspacing="0">
                            <tr onMouseOver="this.style.backgroundColor='#C0E0F8'" onMouseOut="this.style.backgroundColor='#FFFFFF'" style="background-color:#FFFFFF;" height="30" >
								<td align="center" valign="middle"><a href="dlgl/daili.php?1=1" target="mainFrame">代理审核</a></td>
							</tr>
                             <tr onMouseOver="this.style.backgroundColor='#C0E0F8'" onMouseOut="this.style.backgroundColor='#FFFFFF'" style="background-color:#FFFFFF;" height="30" >
								<td align="center" valign="middle"><a href="dlgl/dailist.php?1=1" target="mainFrame">代理列表</a></td>
							</tr>
							<tr onMouseOver="this.style.backgroundColor='#C0E0F8'" onMouseOut="this.style.backgroundColor='#FFFFFF'" style="background-color:#FFFFFF;" height="30" >
								<td align="center" valign="middle"><a href="dlgl/dali_report.php" target="mainFrame">代理月额度</a></td>
							</tr>
						</table>
					</div>
					<?php
					...
					<div class="bg_11" id="bbgl_1">
						<table width="100%" height="30" border="0" cellpadding="0" cellspacing="0">
							...
							<tr onMouseOver="this.style.backgroundColor='#C0E0F8'" onMouseOut="this.style.backgroundColor='#FFFFFF'" style="background-color:#FFFFFF;" height="30" >
								<td align="center" valign="middle"><a href="bbgl/report_day.php" target="mainFrame" >报表明细</a></td>
							</tr>
							<tr onMouseOver="this.style.backgroundColor='#C0E0F8'" onMouseOut="this.style.backgroundColor='#FFFFFF'" style="background-color:#FFFFFF;" height="30" >
								<td align="center" valign="middle"><a href="bbgl/allorder.php" target="mainFrame" >注单统计</a></td>
							</tr>
							<tr onMouseOver="this.style.backgroundColor='#C0E0F8'" onMouseOut="this.style.backgroundColor='#FFFFFF'" style="background-color:#FFFFFF;" height="30" >
					...
					?>
					<div class="bg_10" id="ssgl" onclick="s_h('ssgl','ssgl_1')">赛事管理</div>
					...
					<div class="bg_10" id="livegl" onclick="s_h('livegl','livegl_1')">真人管理</div>
					...
					<div class="bg_11" id="lhcgl_1">
                        <table width="100%" height="30" border="0" cellpadding="0" cellspacing="0">
							<tr onMouseOver="this.style.backgroundColor='#C0E0F8'" onMouseOut="this.style.backgroundColor='#FFFFFF'" style="background-color:#FFFFFF;" height="30" >
								<td align="center" valign="middle"><a href="Six/Six_Auto.php" target="mainFrame">开奖号码管理</a></td>
							</tr>
                            <tr onMouseOver="this.style.backgroundColor='#C0E0F8'" onMouseOut="this.style.backgroundColor='#FFFFFF'" style="background-color:#FFFFFF;" height="30" >
								<td align="center" valign="middle"><a href="Six/Six_Odds.php" target="mainFrame">即时赔率管理</a></td>
							</tr>
                            <tr onMouseOver="this.style.backgroundColor='#C0E0F8'" onMouseOut="this.style.backgroundColor='#FFFFFF'" style="background-color:#FFFFFF;" height="30" >
								<td align="center" valign="middle"><a href="Six/Six_Order.php" target="mainFrame">彩票注单列表</a></td>
							</tr>
						</table>
					</div>
					<?php
					...
					?>
					<div class="bg_10" id="jyqk" onclick="s_h('jyqk','jyqk_1')">交易情况</div>
					...
					if(strpos($quanxian,'sjgl')){
					?>
					<div class="bg_10" id="gfgl" onclick="s_h('gfgl','gfgl_1')">股份管理</div>
					<div class="bg_11" id="gfgl_1">
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							<tr onMouseOver="this.style.backgroundColor='#C0E0F8'" onMouseOut="this.style.backgroundColor='#FFFFFF'" style="background-color:#FFFFFF;" height="30" >
								<td align="center" valign="middle"><a href="gfgl/fbgf.php" target="mainFrame">发布股份</a></td>
							</tr>
							<tr onMouseOver="this.style.backgroundColor='#C0E0F8'" onMouseOut="this.style.backgroundColor='#FFFFFF'" style="background-color:#FFFFFF;" height="30" >
								<td align="center" valign="middle"><a href="gfgl/gftj.php" target="mainFrame">股份统计</a></td>
							</tr>
						</table>
					</div>
					<?php
					...
					<div class="bg_11" id="xtgl_1">
						<table width="100%" height="30" border="0" cellpadding="0" cellspacing="0">
							...
							<tr onMouseOver="this.style.backgroundColor='#C0E0F8'" onMouseOut="this.style.backgroundColor='#FFFFFF'" style="background-color:#FFFFFF; display: none;" height="30" >
					...
					<div class="bg_11" id="glygl_1">
                        <table width="100%" height="30" border="0" cellpadding="0" cellspacing="0">
							<tr onMouseOver="this.style.backgroundColor='#C0E0F8'" onMouseOut="this.style.backgroundColor='#FFFFFF'" style="background-color:#FFFFFF;" height="30" >
								<td align="center" valign="middle"><a href="glygl/user.php" target="mainFrame">管理员管理</a></td>    
							</tr>
						</table>
					</div>
					<?php
