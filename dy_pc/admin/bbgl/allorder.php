...
if(intval($_GET["action"])!=1)
{
	...
	if (!isset($_GET["e_time"]) || $_GET["e_time"]=="") $_GET["e_time"]=date('Y-m-d',time());
}
?>
     ...
     <form name="form1" method="get" action="allorder.php" onSubmit="return check();">
      <tr>
        <td align="left" bgcolor="#FFFFFF">&nbsp;&nbsp;
            ...
            <option value="体育单式" <?=$_GET['caizhong']=='体育单式' ? 'selected' : ''?>>体育单式</option>
            <option value="体育串关" <?=$_GET['caizhong']=='体育串关' ? 'selected' : ''?>>体育串关</option>
            <option value="香港六合彩" <?=$_GET['caizhong']=='香港六合彩' ? 'selected' : ''?>>香港六合彩</option>
            <option value="重庆时时彩" <?=$_GET['caizhong']=='重庆时时彩' ? 'selected' : ''?>>重庆时时彩</option>
            <option value="江西时时彩" <?=$_GET['caizhong']=='江西时时彩' ? 'selected' : ''?>>江西时时彩</option>
            <option value="北京快乐8" <?=$_GET['caizhong']=='北京快乐8' ? 'selected' : ''?>>北京快乐8</option>
            <option value="广东快乐10分" <?=$_GET['caizhong']=='广东快乐10分' ? 'selected' : ''?>>广东快乐10分</option>
            <option value="北京赛车PK拾" <?=$_GET['caizhong']=='北京赛车PK拾' ? 'selected' : ''?>>北京赛车PK拾</option>
            <option value="幸运飞艇" <?=$_GET['caizhong']=='幸运飞艇' ? 'selected' : ''?>>幸运飞艇</option>
            <option value="幸运农场" <?=$_GET['caizhong']=='幸运农场' ? 'selected' : ''?>>幸运农场</option>
            <option value="福彩3D" <?=$_GET['caizhong']=='福彩3D' ? 'selected' : ''?>>福彩3D</option>
            <option value="排列3" <?=$_GET['caizhong']=='排列3' ? 'selected' : ''?>>排列3</option>
          </select>
