...
if($action=="ok")
{
	for($i=1;$i<=$nums;$i++)
	{
		...
		$sql="update c_opentime_4 set kaipan='".$kaipan."',fengpan='".$fengpan."',kaijiang='".$kaijiang."' where qishu=".$i;
		$mysqli->query($sql);
	}
}
?>
...
<div id="pageMain">
	<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="5">
		<tr>
			<td valign="top">
				<form name="FrmSubmit" method="post" action="?action=ok" onsubmit="return confirm('您确定要修改盘口？');">
				<table width="100%" border="0" cellpadding="5" cellspacing="1" class="font12" style="margin-top:5px;" bgcolor="#798EB9">
					<tr>
						...
						<td align="left" bgcolor="#FFFFFF">北京赛车PK拾【<a href="Auto_4.php" style="color:#ff0000;">点击进入开奖设置</a>】</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td align="left" bgcolor="#FFFFFF">
							...
							<input name="submit" type="button" class="submit80" value="刷新" onclick="location.href='Uptime_4.php'" /></td>
					</tr>
				</table>
				<table width="100%" border="0" cellpadding="5" cellspacing="1" class="font12" style="margin-top:5px;" bgcolor="#798EB9">   
					...
					<?php
					$sql="select * from c_opentime_4 order by qishu asc";
