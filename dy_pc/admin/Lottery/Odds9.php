...
if($save=='ok'){
	if($type<4){
		$sql	=	"update c_odds_9 set h1=".$_REQUEST['Num_1'].",h2=".$_REQUEST['Num_2'].",h3=".$_REQUEST['Num_3'].",h4=".$_REQUEST['Num_4'].",h5=".$_REQUEST['Num_5'].",h6=".$_REQUEST['Num_6'].",h7=".$_REQUEST['Num_7'].",h8=".$_REQUEST['Num_8'].",h9=".$_REQUEST['Num_9'].",h10=".$_REQUEST['Num_10'].",h11=".$_REQUEST['Num_11'].",h12=".$_REQUEST['Num_12'].",h13=".$_REQUEST['Num_13'].",h14=".$_REQUEST['Num_14']." where type='ball_".$type."'";
		$mysqli->query($sql);
		message("赔率修改完毕！","odds9.php?type=".$type."");
		exit;
	}
	if($type==4){
		$sql	=	"update c_odds_9 set h1=".$_REQUEST['Num_1'].",h2=".$_REQUEST['Num_2'].",h3=".$_REQUEST['Num_3'].",h4=".$_REQUEST['Num_4'].",h5=".$_REQUEST['Num_5'].",h6=".$_REQUEST['Num_6'].",h7=".$_REQUEST['Num_7']." where type='ball_".$type."'";
		$mysqli->query($sql);
		message("赔率修改完毕！","odds9.php?type=".$type."");
		exit;
	}
	if($type==5){
		$sql	=	"update c_odds_9 set h1=".$_REQUEST['Num_1'].",h2=".$_REQUEST['Num_2'].",h3=".$_REQUEST['Num_3'].",h4=".$_REQUEST['Num_4'].",h5=".$_REQUEST['Num_5']." where type='ball_".$type."'";
		$mysqli->query($sql);
		message("赔率修改完毕！","odds9.php?type=".$type."");
		exit;
	}
	if($type>5){
		$sql	=	"update c_odds_9 set h1=".$_REQUEST['Num_1'].",h2=".$_REQUEST['Num_2'].",h3=".$_REQUEST['Num_3'].",h4=".$_REQUEST['Num_4'].",h5=".$_REQUEST['Num_5'].",h6=".$_REQUEST['Num_6'].",h7=".$_REQUEST['Num_7'].",h8=".$_REQUEST['Num_8'].",h9=".$_REQUEST['Num_9'].",h10=".$_REQUEST['Num_10']." where type='ball_".$type."'";
		$mysqli->query($sql);
		message("赔率修改完毕！","odds9.php?type=".$type."");
		exit;
	}
...
//读取当前期数盘口赔率与投注总额
function loadinfo(){
	$.get("get_odds_9.php", {type : <?=$type?>}, function(data)
		{
...
function UpdateRate(num ,i){
	$.get("updaterate_9.php", {type : <?=$type?> ,num : num ,i : i}, function(data)
		{
