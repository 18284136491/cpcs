...
if($_GET["action"]=="add" && $id==0){ 
	...
	$ball_7		=	$_POST["ball_7"];
	$ball_8		=	$_POST["ball_8"];
	$sql		=	"insert into c_auto_$gameId(qishu,datetime,ball_1,ball_2,ball_3,ball_4,ball_5,ball_6,ball_7,ball_8) values (".$qishu.",'".$datetime."',".$ball_1.",".$ball_2.",".$ball_3.",".$ball_4.",".$ball_5.",".$ball_6.",".$ball_7.",".$ball_8.")";
	$mysqli->query($sql);
	...
	$ball_7		=	$_POST["ball_7"];
	$ball_8		=	$_POST["ball_8"];
	$sql		=	"update c_auto_$gameId set qishu=".$qishu.",datetime='".$datetime."',ball_1=".$ball_1.",ball_2=".$ball_2.",ball_3=".$ball_3.",ball_4=".$ball_4.",ball_5=".$ball_5.",ball_6=".$ball_6.",ball_7=".$ball_7.",ball_8=".$ball_8." where id=".$id."";
	$mysqli->query($sql);
}
