...
if($_GET["action"]=="add" && $id==0){ 
	...
	$ball_2		=	$_POST["ball_2"];
	$ball_3		=	$_POST["ball_3"];
	$sql		=	"insert into c_auto_$gameId(qishu,datetime,ball_1,ball_2,ball_3) values (".$qishu.",'".$datetime."',".$ball_1.",".$ball_2.",".$ball_3.")";
	$mysqli->query($sql);
	...
	$ball_2		=	$_POST["ball_2"];
	$ball_3		=	$_POST["ball_3"];
	$sql		=	"update c_auto_$gameId set qishu=".$qishu.",datetime='".$datetime."',ball_1=".$ball_1.",ball_2=".$ball_2.",ball_3=".$ball_3." where id=".$id."";
	$mysqli->query($sql);
}
...
<div id="pageMain">
  <table width="100%" height="100%" border="0" cellspacing="0" cellpadding="5">
    <tr>
      <td valign="top"><?php include_once("Menu_Auto.php"); ?>
