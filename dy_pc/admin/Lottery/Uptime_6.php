...
if($action=="ok")
{
	for($i=1;$i<=$nums;$i++)
	{
		...
		$sql="update c_opentime_6 set kaipan='".$kaipan."',fengpan='".$fengpan."',kaijiang='".$kaijiang."' where qishu=".$i;
		$mysqli->query($sql);
	}
}
?>
			...
			<td valign="top">
				...
				<table width="100%" border="0" cellpadding="5" cellspacing="1" class="font12" style="margin-top:5px;" bgcolor="#798EB9">
					<tr>
						...
						<td align="left" bgcolor="#FFFFFF">江苏快3【<a href="Auto_6.php" style="color:#ff0000;">点击进入开奖设置</a>】</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td align="left" bgcolor="#FFFFFF">
							...
							<input name="submit" type="button" class="submit80" value="刷新" onClick="location.href='Uptime_2.php'" /></td>
					</tr>
				</table>
				<table width="100%" border="0" cellpadding="5" cellspacing="1" class="font12" style="margin-top:5px;" bgcolor="#798EB9">   
					...
					<?php
					$sql="select * from c_opentime_6 order by qishu asc";
