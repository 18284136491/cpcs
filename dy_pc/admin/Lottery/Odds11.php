...
//读取当前期数盘口赔率与投注总额
function loadinfo(){
	$.post("get_odds_11.php", {type : <?=$type?>}, function(data)
		{
...
function UpdateRate(num ,i){
	$.post("updaterate_11.php", {type : <?=$type?> ,num : num ,i : i}, function(data)
		{
