...
//获取开奖号码
$sql		= "select * from c_auto_11 where ok=0 ";
...
$hm[]		= $rs['ball_8'];
//根据期数读取未结算的注单
$sql1		= "select * from c_bet where type='幸运农场' and js=0 and qishu=".$qi." order by addtime asc";
...
$msql="update c_auto_11 set ok=1 where qishu=".$qi."";
