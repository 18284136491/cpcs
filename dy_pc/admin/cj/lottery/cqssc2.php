...
$curl->set_referrer("http://www.1680180.com/lottery/10011.html");
...
$html_data = $curl->fetch_url("http://www.1680180.com/Open/CurrentOpen?code=10011&_=0.3424344145450467");
$a=array('(',')');
$b=array('[',']');
