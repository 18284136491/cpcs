...
//获取开奖号码
$sql		= "select * from c_auto_4 where ok=0 ";
...
$hm[]		= $rs['ball_10'];
//根据期数读取未结算的注单
$sql1		= "select * from c_bet where type='北京赛车PK拾' and js=0 and qishu=".$qi." order by addtime asc";
...
if ($_GET['t']==1)    {
echo "<script>window.location.href='../../Lottery/auto_4.php';</script>";
}
}
?>