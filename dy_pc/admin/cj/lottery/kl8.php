	...
	if(strlen($qihao)>0){
		$sql="select id from c_auto_1 where qishu='".$qihao."' ";
			...
			if($tcou==0){
				...
				values ('$qihao','$time','$hm1','$hm2','$hm3','$hm4','$hm5','$hm6','$hm7','$hm8','$hm9','$hm10','$hm11','$hm12','$hm13','$hm14','$hm15','$hm16','$hm17','$hm18','$hm19','$hm20')";	
				$mysqli->query($sql);
			$m=$m+1;
		}
	}
...
<iframe src="Js_1.php?qi=<?=$qihao?>" frameborder="0" scrolling="no" height="0" width="0"></iframe>
</body>
</html>