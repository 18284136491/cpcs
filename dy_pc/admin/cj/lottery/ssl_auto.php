...
<body>
<?
$mysql = "select * from lottery_k_ssl where qihao=".$qi;
...
$hmhz = $bw+$sw+$gw;
$sql = "select * from lottery_data where atype='ssl' and mid='".$qi."' and bet_ok=0 order by ID asc";
...
$msql="update lottery_k_ssl set ok=1 where qihao=".$qi;
