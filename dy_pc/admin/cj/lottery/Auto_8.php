...
foreach($ul_arr2[1] as $arr){
	...
	if(strlen($qishu)>0){
		...
		if($tcou==0){
			...
			$usql="update c_auto_8 set ball_1=$ball_1,ball_2=$ball_2,ball_3=$ball_3,ball_4=$ball_4,ball_5=$ball_5,ball_6=$ball_6,ball_7=$ball_7,ball_8=$ball_8,ball_9=$ball_9,ball_10=$ball_10,datetime='".$time."' where qishu='".$qishu."'";
			//	echo $usql."<br>";
			$mysqli->query($usql);
		}
	}
...
<? if($is_js){?>
<iframe src="js_8.php?qi=<?=$qishu?>" frameborder="0" scrolling="no" height="0" width="0"></iframe>
<? }?>
</body>
</html>