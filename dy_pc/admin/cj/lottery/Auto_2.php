...
$agent="Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Maxthon/4.4.6.2000 Chrome/30.0.1599.101 Safari/537.36";
//var_dump($cookie);exit;
$curl->set_referrer("http://www.cqcp.net/game/ssc/");
//$curl->set_cookie($ckk);
$curl->include_response_headers(0);
$curl->set_user_agent($agent);
$post_data = array('idMode' => '3002', 'iCount' => '1');
$html_data = $curl->send_post_data("http://www.cqcp.net/game/ssc/", $post_data);
//echo $html_data;exit;
$a = array(
"if(self == top)",
"<script>",
...
<iframe src="js_2.php?qi=<?=$ball_qishu?>" frameborder="0" scrolling="no" height="0" width="0"></iframe>
</body>
</html>