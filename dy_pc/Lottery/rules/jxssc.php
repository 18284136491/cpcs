...
<body>
    <div class="yx_gz">
        ...
        <div class="guize">
            <p class="f20">天津时时彩规则说明</p>
            <p class="b m_tb">简介</p>
            <p>天津时时彩由中国福利彩票发行管理中心组织，由天津市福利彩票发行中心在所辖区域内承销。该游戏的投注时间、开奖时间和开奖号码与天津时时彩完全同步，北京时间（GMT+8）每天白天从上午9：00开到晚上23：00，每 10 分钟开一次奖，每天开奖 84 期。<br>
                本公司天津时时彩具体游戏规则如下︰开奖结果为五码 (万、仟、佰、拾、个)。假设结果为1 、2 、3 、4、5。</p>
            ...
            <p><span class="b">※大小：</span>根据相应单项投注的第一球 ~ 第五球开出的球号大于或等于 5 为特码大，小于或等于 4 为特码小。</p>
            <p><span class="b">※单双：</span>根据相应单项投注的第一球 ~ 第五球开出的球号为双数则为特码双，如 2、6；球号为单数则为特码单，如 1、3。</p>
            <p class="c_t m_tb">2、总和</p>
            <p><span class="b">※大小：</span>根据相应单项投注的第一球 ~ 第五球开出的球号数字总和值大于或等于 23 为总和大，小于或等于 22 为总和小。</p>
            ...
            <p><span class="">※半顺：</span>开奖号码的百位十位个位任意两位数字相连，不分顺序（不包括顺子、对子）。如中奖号码为：XX125、XX540、XX390、XX160...开奖号码的百位十位个位有两位数字相连，则投注后三半顺者视为中奖，其它视为不中奖。如果开奖号码为后三顺子、后三对子，则后三半顺视为不中奖。如开奖号码为：XX123、XX901、XX556、XX233...视为不中奖。</p>
