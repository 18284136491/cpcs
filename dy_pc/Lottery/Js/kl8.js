	...
	for(var i = 1; i < 9; i++) {
		if(i >= 1 && i <= 5) {
			for(var s = 1; s < 81; s++) {
                ...
                if(g_type == 1) {
                    odds = '<a href="javascript:void(0);" title="按此下注">' + odds + '</a>';
                }
            ...
            if(g_type == 1) {
                n_p.html("选一中一赔率为：<span style='color: red'><b>" + oddslist.ball[g_type][1] + "</b></span>");
            } else if(g_type == 2) {
                n_p.html("选二中二赔率为：<span style='color: red'><b>" + oddslist.ball[g_type][1] + "</b></span>");
            } else if(g_type == 3) {
                n_p.html("选三中二赔率为：<span style='color: red'><b>" + oddslist.ball[g_type][2] + "</b></span>；选三中三赔率为：<span style='color: red'><b>" + oddslist.ball[g_type][1] + "</b></span>");
            } else if(g_type == 4) {
                n_p.html("选四中二赔率为：<span style='color: red'><b>" + oddslist.ball[g_type][3] + "</b></span>；选四中三赔率为：<span style='color: red'><b>" + oddslist.ball[g_type][2] + "</b></span>；选四中四赔率为：<span style='color: red'><b>" + oddslist.ball[g_type][1] + "</b></span>");
            } else if(g_type == 5) {
                n_p.html("选五中三赔率为：<span style='color: red'><b>" + oddslist.ball[g_type][3] + "</b></span>；选五中四赔率为：<span style='color: red'><b>" + oddslist.ball[g_type][2] + "</b></span>；选五中五赔率为：<span style='color: red'><b>" + oddslist.ball[g_type][1] + "</b></span>");
            }
		} else if(i == 6) {
			for(var s = 1; s < 6; s++) {
