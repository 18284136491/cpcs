    ...
    <table cellspacing="0" cellpadding="0" border="0" class="gm_t3">
        <tr>
            <td height="27">
                ...
                <span class="gm_type">生肖连</span>
                <input id="gm_mode" type="hidden" value="six_13" />
    ...
    <div class="touzhu">
        <form name="orders" id="orders" action="order/order.php?type=0&class=13" method="post" target="OrderFrame">
            <table cellspacing="1" cellpadding="0" border="0" class="tab1 mt5 six_1">
                ...
                <tr class="tr_txt">
                    <td>
                        <input name='ball_13' type="radio" value='1'/> 二肖连中
                        <input name='ball_13' type="radio" value='2' style="margin-left: 20px"/> 三肖连中
                        <input name='ball_13' type="radio" value='3' style="margin-left: 20px"/> 四肖连中
                        <input name='ball_13' type="radio" value='4' style="margin-left: 20px"/> 五肖连中
                    </td>
                </tr>
            </table>
