    ...
    <table cellspacing="0" cellpadding="0" border="0" class="gm_t3">
        <tr>
            <td height="27">
                ...
                <span class="gm_type">连码</span>
                <input id="gm_mode" type="hidden" value="six_11" />
            ...
            <table cellspacing="1" cellpadding="0" border="0" class="tab1 mt5 six_1">
                ...
                <tr class="tr_txt">
                    <td colspan="12">
                        ...
                        <span id="type_2" style="margin-left: 20px"><input name='type' type="radio" value='2'/> 生肖对碰</span>
                        <span id="type_3" style="margin-left: 20px"><input name='type' type="radio" value='3'/> 尾数对碰</span>
                        <span id="type_4" style="margin-left: 20px"><input name='type' type="radio" value='4'/> 肖串尾数</span>
                        <span id="type_5" style="margin-left: 20px"><input name='type' type="radio" value='5'/> 托胆</span>
                    </td>
                </tr>
            </table>
            <table id="ball_1" cellspacing="1" cellpadding="0" border="0" class="tab1 mt10 six" style="display: none">
                <tr class="tit">
                    <td>号码</td>
                    <td>选择</td>
                    <td>号码</td>
