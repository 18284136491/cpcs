	...
	<table width="100%" border="0" cellpadding="0" cellspacing="1">
		<tr>
			<td colspan="2" class="pay_ma">
				<span><img src="images/zfb.jpg" width="200" /></span>
				<span>
					1、请用支付宝扫描二维码，进行付款！<br/>
					2、最低入款金额为100元！<br/>
		...
		<form id="form1" method="post" action="hk_money.php?into=true" name="form1">
			...
			<tr>
				<td class="bg" align="right">支付宝昵称：</td>
			...
			<tr>
				...
				<td height="50">
					<input type="hidden" name="IntoBank" value="支付宝转账" />
					<input type="hidden" name="InType" value="支付宝转账" />
