...
function loaded(league,thispage){
	...
	$.getJSON("guanjun_result_data.php?leaguename="+league+"&CurrPage="+thispage+"&callback=?",function(json){
		...
		if(pagecount == 0){
			$("#datashow").html("<table border='0' cellspacing='1' cellpadding='0' bgcolor='#ACACAC' class='box'><tr><th width='100'>比赛时间</th><th>联盟玩法</th><th>比赛队伍</th><th>胜出</th></tr><tr><td height='100' align='center' bgcolor='#FFFFFF' colspan='4'>暂无任何赛果</td></tr></table>");
			$("#top").html("");
		}else{
			var tem_arr = new Array();
			tem_arr = opt.split("|");
			var tem_arr2 = new Array();
			var htmls = "<table border='0' cellspacing='1' cellpadding='0' bgcolor='#ACACAC' class='box'><tr><th width='100'>比赛时间</th><th>联盟玩法</th><th>比赛队伍</th><th>胜出</th></tr>";
