			...
			for(var i=0; i<dbs.length; i++){
				...
				htmls +="<div class='bisai'>";
					...
					htmls +="<div class='zhudui'>";
						htmls +="<div class='hui_x zu_shang_2 zu_2Scolor1'>"+dbs[i]["Match_Master"]+"<span style=color:#666666;> -[上半]</span></div>";
						...
						htmls +="<div class='hui_z zu_4'>";
							htmls +="<div class='hui_z zu_4_1'>"+((dbs[i]["Match_Bdxpk1"]!="大")?dbs[i]["Match_Bdxpk1"].replace("@",""):"")+"</div>";
					...
					htmls +="<div class='kedui'>";
						...
						htmls +="</div>";
						htmls +="<div class='hui_z_zq zu_4'>";
							htmls +="<div class='hui_z zu_4_1'>"+((dbs[i]["Match_Bdxpk2"]!="小")?dbs[i]["Match_Bdxpk2"].replace("@",""):"")+"</div>";
					...
					htmls +="</div>";
					htmls +="<div class='kedui'>";
						htmls +="<div class='hui_x2 zu_shang_2 zu_2Scolor3'>和局</div>";
