			...
			htmls+="<div onmouseover=\"this.className='d_over'\" onmouseout=\"this.className='d_out'\">";	
				htmls+="<div class=\"bisai_bo\">";
					...
					htmls+="<div class=\"zhudui_bo\">";
                        ...
                        htmls+="<div class='lan_gunqiu_dy_zu1'>"+(dbs[i]["Match_BzM"]=="0" ? "" :("<a href=\"javascript:void(0)\" title=\""+dbs[i]["Match_Master"]+"\" onclick=\"javascript:setbet('篮球单式','标准盘-"+dbs[i]["Match_Master"]+"-独赢','"+dbs[i]["Match_ID"]+"','Match_BzM','0','0','"+dbs[i]["Match_Master"]+"');\" style='"+(dbs[i]["Match_BzM"]!=data[i]["Match_BzM"] && data[i]["Match_ID"]==dbs[i]["Match_ID"]?"background:#FFCC00":"")+"'>"+formatNumber(dbs[i]["Match_BzM"],2)+"</a>"))+"</div>";
						htmls+="</div>";
						...
						htmls+="<div class=\"hui_z lan_gunqiu_dx_zu2\">"+(dbs[i]["Match_DxDpl"]=="0" ? "" :("<a href=\"javascript:void(0)\" title=\"大\" onclick=\"javascript:setbet('篮球单式','大小"+dbs[i]["Match_DxDpl"]+"','"+dbs[i]["Match_ID"]+"','Match_DxDpl','1','0','"+dbs[i]["Match_DxGG1"]+"');\" style='"+(dbs[i]["Match_DxGG1"]!=data[i]["Match_DxGG1"] && data[i]["Match_ID"]==dbs[i]["Match_ID"]?"background:#FFCC00":"")+"'>"+formatNumber(dbs[i]["Match_DxDpl"],2)+"</a>"))+"</div>";
						htmls+="</div>";
						htmls+="<div class=\"bodan_x lan_gunqiu_ds\">";
						htmls+="<div class=\"hui_z lan_gunqiu_ds_zu1\">"+(dbs[i]["Match_DsDpl"]>"0" ? "单" :"")+"</div>";
						htmls+="<div class=\"hui_z lan_gunqiu_ds_zu2\">"+(dbs[i]["Match_DsDpl"]<="0" ? "" :("<a href=\"javascript:void(0)\" title=\"单\" onclick=\"javascript:setbet('篮球单式','单双-单','"+dbs[i]["Match_ID"]+"','Match_DsDpl','0','0','单');\" style='"+(dbs[i]["Match_DsDpl"]!=data[i]["Match_DsDpl"] && data[i]["Match_ID"]==dbs[i]["Match_ID"]?"background:#FFCC00":"")+"'>"+formatNumber(dbs[i]["Match_DsDpl"],2)+"</a>"))+"</div>";
						htmls+="</div>";
						...
						htmls+="<div class=\"hui_z lan_gunqiu_dfdx_zu2\">"+(dbs[i]["Match_DFzDpl"]=="0" ? "" :("<a href=\"javascript:void(0)\" title=\"主大\" onclick=\"javascript:setbet('篮球单式','主队大小-"+dbs[i]["Match_DFzDX1"]+"','"+dbs[i]["Match_ID"]+"','Match_DFzDpl','1','0','"+dbs[i]["Match_DFzDX1"]+"');\" style='"+(dbs[i]["Match_DFzDX1"]!=data[i]["Match_DFzDX1"] && data[i]["Match_ID"]==dbs[i]["Match_ID"]?"background:#FFCC00":"")+"'>"+formatNumber(dbs[i]["Match_DFzDpl"],2)+"</a>"))+"</div>";
						htmls+="</div>";
						...
						htmls+="<div class=\"hui_z lan_gunqiu_dfdx_zu2\">"+(dbs[i]["Match_DFzXpl"]=="0" ? "" :("<a href=\"javascript:void(0)\" title=\"主小\" onclick=\"javascript:setbet('篮球单式','主队大小-"+dbs[i]["Match_DFzDX2"]+"','"+dbs[i]["Match_ID"]+"','Match_DFzXpl','1','0','"+dbs[i]["Match_DFzDX2"]+"');\" style='"+(dbs[i]["Match_DFzXpl"]!=data[i]["Match_DFzXpl"] && data[i]["Match_ID"]==dbs[i]["Match_ID"]?"background:#FFCC00":"")+"'>"+formatNumber(dbs[i]["Match_DFzXpl"],2)+"</a>"))+"</div>";
						htmls+="</div>";
					...
					htmls+="<div class=\"kedui_bo\">";
						...
						htmls+="<div class='lan_gunqiu_dy_zu1'>"+(dbs[i]["Match_BzG"]=="0" ? "" :("<a href=\"javascript:void(0)\" title=\""+dbs[i]["Match_Guest"]+"\" onclick=\"javascript:setbet('篮球单式','标准盘-"+dbs[i]["Match_Guest"]+"-独赢','"+dbs[i]["Match_ID"]+"','Match_BzG','0','0','"+dbs[i]["Match_Guest"]+"');\"  style='"+(dbs[i]["Match_Guest"]!=data[i]["Match_Guest"] && data[i]["Match_ID"]==dbs[i]["Match_ID"]?"background:#FFCC00":"")+"'>"+formatNumber(dbs[i]["Match_BzG"],2)+"</a>"))+"</div>";
						htmls+="</div>";
						...
						htmls+="<div class=\"hui_z lan_gunqiu_dx_zu2\">"+(dbs[i]["Match_DxXpl"]=="0" ? "" :("<a href=\"javascript:void(0)\" title=\"小\" onclick=\"javascript:setbet('篮球单式','大小"+dbs[i]["Match_DxXpl"]+"','"+dbs[i]["Match_ID"]+"','Match_DxXpl','1','0','"+dbs[i]["Match_DxGG2"]+"');\" style='"+(dbs[i]["Match_DxXpl"]!=data[i]["Match_DxXpl"] && data[i]["Match_ID"]==dbs[i]["Match_ID"]?"background:#FFCC00":"")+"'>"+formatNumber(dbs[i]["Match_DxXpl"],2)+"</a>"))+"</div>";
						htmls+="</div>";
						htmls+="<div class=\"bodan_x_bor lan_gunqiu_ds\">";
						htmls+="<div class=\"hui_z lan_gunqiu_ds_zu1\">"+(dbs[i]["Match_DsSpl"]!="0" ? "双" :"")+"</div>";
						htmls+="<div class=\"hui_z lan_gunqiu_ds_zu2\">"+(dbs[i]["Match_DsDpl"]<="0" ? "" :("<a href=\"javascript:void(0)\" title=\"双\" onclick=\"javascript:setbet('篮球单式','单双-双','"+dbs[i]["Match_ID"]+"','Match_DsSpl','0','0','双');\" style='"+(dbs[i]["Match_DsDpl"]!=data[i]["Match_DsDpl"] && data[i]["Match_ID"]==dbs[i]["Match_ID"]?"background:#FFCC00":"")+"'>"+formatNumber(dbs[i]["Match_DsSpl"],2)+"</a>"))+"</div>";
						htmls+="</div>";
						...
						htmls+="<div class=\"hui_z lan_gunqiu_dfdx_zu2 lan_gunqiu_dfdx_bb2\">"+(dbs[i]["Match_DFkDpl"]=="0" ? "" :("<a href=\"javascript:void(0)\" title=\"客大\" onclick=\"javascript:setbet('篮球单式','客队大小-"+dbs[i]["Match_DFkDX1"]+"','"+dbs[i]["Match_ID"]+"','Match_DFkDpl','1','0','"+dbs[i]["Match_DFkDX1"]+"');\" style='"+(dbs[i]["Match_DFkDX1"]!=data[i]["Match_DFkDX1"] && data[i]["Match_ID"]==dbs[i]["Match_ID"]?"background:#FFCC00":"")+"'>"+formatNumber(dbs[i]["Match_DFkDpl"],2)+"</a>"))+"</div>";
						htmls+="</div>";
