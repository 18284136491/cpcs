...
$sql = "select id from bet_match WHERE Match_Type=0 AND Match_CoverDate>now() and match_date!='" . date("m-d") . "' " . $sqlwhere . ' order by Match_CoverDate,iPage,match_name,Match_Master,Match_ID,iSn';
