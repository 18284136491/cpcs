...
function loaded(league,thispage,p){
	...
	$.getJSON("bkz_danjie_data.php?leaguename="+league+"&CurrPage="+thispage+"&callback=?",function(json){	
		...
		if(pagecount == "error1"){
			...
			htmls+="<div class='d_out' onmouseover=\"this.className='d_over'\" onmouseout=\"this.className='d_out'\">";
...
$(document).ready(function(){
	$("#xzls").click(function(){ //选择联赛
		JqueryDialog.Open('篮美早餐单节', 'dialog.php?lsm='+window_lsm, 600, window_hight);
	});
});